...
export const functions = {
    ...
    adminTransfer: fun("0xca61f313", "adminTransfer(address[],address[],uint256[])", {"from": p.array(p.address), "to": p.array(p.address), "tokenIds": p.array(p.uint256)}, ),
    ...
    batchMintTo: fun("0x0379b1d0", "batchMintTo(address[],uint256[])", {"to": p.array(p.address), "tokenIds": p.array(p.uint256)}, ),
    ...
    requestBatchMetadataUpdate: fun("0x4b9ddedc", "requestBatchMetadataUpdate(uint256,uint256)", {"_fromTokenId": p.uint256, "_toTokenId": p.uint256}, ),

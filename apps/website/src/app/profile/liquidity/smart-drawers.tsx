...
} from "@/app/profile/liquidity/buttons";
...
const FarmSmartDrawer = ({ action = "Deposit", poolJson, disabled, className }: FarmSheetProps) => {
  ...
  return (
    <SmartDrawer>
      <SmartDrawerTrigger asChild>
        <ChainButton className={cn("w-full font-bold", className)}>{action}</ChainButton>
      </SmartDrawerTrigger>
      <SmartDrawerContent>
...
const BankSmartDrawer = ({ action = "Deposit", json, disabled, className }: XEvoSheetProps) => {
  ...
  return (
    <SmartDrawer>
      <SmartDrawerTrigger asChild>
        <ChainButton className={cn("w-full font-bold", className)} disabled={disabled}>{action}</ChainButton>
      </SmartDrawerTrigger>
      <SmartDrawerContent>
        <SmartDrawerHeader className="sm:text-center">

...
export const ProfileForm = () => {
  ...
  const eoaWallets = useConnectedWallets({ includeSmart: false });
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="text" placeholder="Not Set..." {...field} className="max-w-92" />
              </FormControl>
              <FormDescription>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <div className="flex">
                ...
                >
                  <FormControl>
                    <SelectTrigger className="w-full max-w-92">
                      <SelectValue
                  ...
                  <SelectContent>
                    {eoaWallets.map(w => w.getAccount()?.address).filter(Boolean).map(wallet => (
                      <SelectItem key={wallet} value={wallet!} className="font-mono">{wallet}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
                {/*<LinkWalletButton*/}

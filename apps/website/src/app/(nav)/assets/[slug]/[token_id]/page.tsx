import { AssetActivity } from "@/app/(nav)/assets/[slug]/[token_id]/asset-activity";
import { AssetAttributes } from "@/app/(nav)/assets/[slug]/[token_id]/asset-attributes";
import { AssetBreeding } from "@/app/(nav)/assets/[slug]/[token_id]/asset-breeding";
import { AssetDetails } from "@/app/(nav)/assets/[slug]/[token_id]/asset-details";
import { AssetImage } from "@/app/(nav)/assets/[slug]/[token_id]/asset-image";
import { AssetMarketplaceCard } from "@/app/(nav)/assets/[slug]/[token_id]/asset-marketplace-card";
import { AssetStats } from "@/app/(nav)/assets/[slug]/[token_id]/asset-stats";
